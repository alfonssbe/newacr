...
//   const videoData = [
//     { id: 'MbZs_K_xHKo', title: 'NEW RELEASE ACR 12IN 12500 BLACK BY SINAR BAJA ELECTRIC' },
//     { id: 'qV3j27Uq0dA', title: 'COMING SOON CD 75 DESIBEL BY SINAR BAJA ELECTRIC' },
//     { id: 'dziB6o_JARE', title: 'ACR RHYME DESIBEL DI PARADE SOUND SYSTEM SURABAYA' },
//     { id: 'V5IqZNVPBxg', title: 'NEW RELEASE 10in 10500 BLACK SERIES SPEAKER LOKAL KARYA ANAK BANGSA' },
//     { id: 'i8PhjelyUMQ', title: 'NEW RELEASE CD 251 BLACK SERIES' },
//     { id: 'BW7aMvP8dCo', title: 'NEW RELEASE 8IN ARRAY 8388 M FAB LIMITED EDITION BY SINAR BAJA ELECTRIC' },
//   ];
...
//                 <Image src="/images/acr/acryoutubeprofile.jpg" alt="ACR Rhyme Youtube Channel" className="rounded-full" width={100} height={100} />
//               </div>
//               <div>
...
//                 <div
//                   className="w-full lg:h-60 h-40 rounded-lg flex items-center justify-center cursor-pointer relative"
...
//                     <Play width={30} height={30} className='text-primary'/>
//                   </div>
//                 </div>
//               ) : (
//                 <iframe
...
//       try {
//         const res = await fetch('/api/youtube') // create this API route
...
//         <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-center pt-8">
//           {loading && <div className="text-center col-span-full py-10">Loading videos...</div>}
