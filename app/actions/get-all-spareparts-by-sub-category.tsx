...
const API=`${process.env.NEXT_PUBLIC_ROOT_URL}/${process.env.NEXT_PUBLIC_FETCH_ALL_SPAREPARTS_BY_SUB_CATEGORY}`;

const getAllSparepartBySubCategory = async (subcategory: string): Promise<CachedAllProducts> => {
  ...
  const API_EDITED = API.replace('{sparepartSubCategory}', subcategory)
...
export default getAllSparepartBySubCategory;
