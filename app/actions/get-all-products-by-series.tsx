...
const getAllProductsBySeries = async (subcategory: string, series: string): Promise<CachedAllProducts> => {
  ...
  const API_EDITED = API_EDITED_FIRST.replace('{productSeries}', series)
...
export default getAllProductsBySeries;
