...
export const CellAction: React.FC<CellActionProps> = ({
  ...
  const onConfirm = async () => {
    try {
      ...
      const API_EDITED2 = API_EDITED.replace('{heroId}', data.id)
  ...
  const onCopy = (id: string) => {
    ...
    toast.success('Hero ID copied to clipboard.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`${process.env.NEXT_PUBLIC_ADMIN_FOLDER_URL}/${params.brandId}/hero/${data.id}`)}
          >
