...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/app/[lang]/components/ui/accordionmobilemenu";
    ...
    allParent.forEach((item) => {
      if(item.nameEnglish != ""){
        ...
        let temp: PriorityMenu = {    
          priorityId: '',
          productId: item.id,
          productNameEnglish: item.nameEnglish,
                    ...
                    {products.map((prod, index) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <div className="text-left">{prod.productNameEnglish}</div>
                        </div>
                        {prod.priority === '999' &&
